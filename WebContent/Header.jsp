			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<a class="navbar-brand" href="web/index.html">Prison<span>Management</span></a>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-12" id="link-effect-12">
						<ul class="nav navbar-nav">
							<li><a href="web/index.html"><span>Home</span></a></li>
							<!-- <li><a href="web/services.html"><span>Services</span></a></li>
							<li><a href="web/short-codes.html"><span>Short Codes</span></a></li>
							<li class="active"><a href="web/mail.html"><span>Mail Us</span></a></li> -->
						</ul>
					</nav>
				</div>
				</nav>
